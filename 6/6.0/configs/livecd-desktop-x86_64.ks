# from f13 spin kickstarts package, fedora-livecd-desktop.ks
#version=DEVEL
...
# todo: baseurl should be set by el-build/bake/v-bake/...
repo --name="ascendos-60" --baseurl=EL_BUILD_CACHE_ROOT/http/build.ascendos.org/linux/ascendos/6.0/os/x86_64
